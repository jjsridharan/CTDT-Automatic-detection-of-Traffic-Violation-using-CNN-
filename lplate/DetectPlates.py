...
from lplate import Preprocess
from lplate import DetectChars
from lplate import PossiblePlate
from lplate import PossibleChar
...
def detectPlatesInScene(imgOriginalScene):
    ...
    for listOfMatchingChars in listOfListsOfMatchingCharsInScene:                   # for each group of matching chars
        possiblePlate,ptPlateCenter = extractPlate(imgOriginalScene, listOfMatchingChars)         # attempt to extract plate
        if possiblePlate.imgPlate is not None:                          # if plate was found
            listOfPossiblePlates.append([possiblePlate,ptPlateCenter])                  # add to list of possible plates
        # end if
    # end for
    ...
    if Main.showSteps == True: # show steps #######################################################
        ...
        for i in range(0, len(listOfPossiblePlates)):
            p2fRectPoints = cv2.boxPoints(listOfPossiblePlates[i][0].rrLocationOfPlateInScene)
            ...
            cv2.imshow("4b", listOfPossiblePlates[i][0].imgPlate)
            cv2.waitKey(0)
        # end for
...
def extractPlate(imgOriginal, listOfMatchingChars):
    ...
    return possiblePlate,ptPlateCenter
# end function
